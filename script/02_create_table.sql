...
CREATE TABLE OIC.TF_ACTIF_DATA_ET_DATE_ACTIVATION(
  MSISDN BIGINT,
...
CREATE TABLE OIC.TF_CDR_TRAFFIC_CUSTOMER_CELL(
  day TIMESTAMP,
  idCust STRING,
  idGGSN STRING,
  idRAT STRING,
...
CREATE TABLE OIC.TF_CDR_TRAFFIC_CUSTOMER(
  day TIMESTAMP,
  idCust STRING,
  idAppli STRING,
  idAPN STRING,
...
CREATE TABLE OIC.TF_CONVERSIONS_ID_APN (
  Id_APN STRING,
...
CREATE TABLE OIC.TF_CONVERSIONS_ID_APPLI (
  Id_appli STRING,
...
CREATE TABLE OIC.TF_CONVERSIONS_ID_CUST_CONTACT (
...
CREATE TABLE OIC.TF_CONVERSIONS_ID_GGSN (
  Id_GGSN String,
...
CREATE TABLE OIC.TF_CONVERSIONS_ID_RAT (
  Id_RAT STRING,
...
CREATE TABLE OIC.TF_CONVERSIONS_ID_CUST_MSISDN (
  Id_customer STRING,
  MSISDN STRING
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_LOCALISATION_CELLULES (
...
CREATE TABLE OIC.TF_DONNEES_HISTO_MENSUELLES(
  MONTH_ID STRING,
  MSISDN STRING,
  GEOLOCALITE STRING,
  COMMUNE STRING,
...
CREATE TABLE OIC.TF_CDR_ENTRANT(
  DATE_ID TIMESTAMP,
  MSISDN STRING,
...
CREATE TABLE OIC.TF_INFO_TERMINAUX(
  DATE_ID TIMESTAMP,
  MSISDN STRING,
  CODE_TAC STRING,
  MODELE STRING,
...
CREATE TABLE OIC.TF_REFERENTIEL_TERMINAUX(
  TAC STRING,
  PRODUCT_ID STRING,
...
CREATE TABLE OIC.TF_CDR_SORTANT(
  DATE_ID TIMESTAMP,
  MSISDN STRING,
  MSISDN_APPELANT STRING,
  MSISDN_APPELE STRING,
...
CREATE TABLE OIC.TF_TRANSACTION_OM(
  MONTH_ID TIMESTAMP,
  MSISDN STRING,
...
CREATE TABLE OIC.TF_customers_sp_day_201611(
  id_cust string,
...
CREATE TABLE OIC.TF_customers_sp_day_201612(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_day_201701(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_day_201702(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_day_201703(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_day_201704(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201611(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201612(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201701(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201702(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201703(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201704(
  id_cust string,
  serv_provider string
  )
STORED AS AVRO;
...
CREATE TABLE OIC.TF_customers_sp_month_201705(
  id_cust string,
  serv_provider string,
  period timestamp
  )
