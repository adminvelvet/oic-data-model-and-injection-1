...
CREATE TABLE OIC.TF_ACTIF_DATA_ET_DATE_ACTIVATION (
  DATE_SOUSCRIPTIONMSISDN DATE,
  TYPE_SOUSCRIPTION STRING,
  NOMBRE_SOUSCRIPTION INT,
...
DESCRIBES OIC.TF_BUNDLE;
SELECT * FROM OIC.TF_BUNDLE WHERE PRT_DATE = '20161102'
...
SELECT * FROM OIC.TF_BUNDLE_10PCT WHERE PRT_DATE = '20161102'
